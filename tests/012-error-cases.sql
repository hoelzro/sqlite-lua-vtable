...
CREATE VIRTUAL TABLE test1 USING error_tester('
return {
...
CREATE VIRTUAL TABLE test2 USING error_tester('
return {
  __fromsqlite = function(value)
    return nil
  end,
...
CREATE VIRTUAL TABLE test3 USING error_tester('
return {
  __fromsqlite = function(value)
    return { data = value }
  end,
...
CREATE VIRTUAL TABLE test4 USING error_tester('
return {
  __tosqlite = function(value)
    return value.data
  end,
...
CREATE VIRTUAL TABLE test5 USING error_tester('
return {
  __fromsqlite = "not a function",
  __tosqlite = function(value)
    return value.data
...
CREATE VIRTUAL TABLE test6 USING error_tester('
return {
  __fromsqlite = function(value)
    return { data = value }
  end,
...
CREATE VIRTUAL TABLE test7 USING error_tester('
return {
  __fromsqlite = function(value)
    return { data = value }
  end,
...
CREATE VIRTUAL TABLE test8 USING error_tester('
return {
  __fromsqlite = function(value)
    return { data = value }
  end,
...
CREATE VIRTUAL TABLE test9 USING error_tester('
return {
  __fromsqlite = function(value)
